...
namespace libx
{
    ...
    public class Updater : MonoBehaviour, IUpdater, INetworkMonitorListener
    {
        ...
        public void OnReachablityChanged(NetworkReachability reachability)
        {
            ...
            {
                MessageBox.Show("ErrorNetwork").onComplete += delegate(MessageBox.EventId id)
                {
        ...
        private IEnumerator RequestVersions()
        {
            ...
            {
                var mb = MessageBox.Show("ErrorNetwork");
                yield return mb;
                if (mb.isOk)
                {
                    StartUpdate();
            ...
            catch (Exception e)
            {
                ...
                MessageBox.Show("ErrorNetwork").onComplete +=
