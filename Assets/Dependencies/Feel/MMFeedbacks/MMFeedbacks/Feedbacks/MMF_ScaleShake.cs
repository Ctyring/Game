...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_ScaleShake : MMF_Feedback
	{
		...
		protected override void CustomPlayFeedback(Vector3 scale, float feedbacksIntensity = 1.0f)
		{
		...
		/// <param name="scale"></param>
		/// <param name="feedbacksIntensity"></param>
		protected override void CustomStopFeedback(Vector3 scale, float feedbacksIntensity = 1)
		{
			if (!Active || !FeedbackTypeAuthorized)
			{
				return;
