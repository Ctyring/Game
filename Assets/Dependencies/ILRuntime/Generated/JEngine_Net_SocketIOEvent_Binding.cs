...
{
    unsafe class JEngine_Net_SocketIOEvent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(JEngine.Net.SocketIOEvent);
            args = new Type[]{};
        ...
        static StackObject* get_name_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            JEngine.Net.SocketIOEvent instance_of_this_method = (JEngine.Net.SocketIOEvent)typeof(JEngine.Net.SocketIOEvent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
