...
{
    unsafe class JEngine_AntiCheat_JLong_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(JEngine.AntiCheat.JLong);
            MethodInfo[] methods = type.GetMethods(flag).Where(t => !t.IsGenericMethod).ToArray();
            args = new Type[]{typeof(JEngine.AntiCheat.JLong)};
            ...
            method = methods.Where(t => t.Name.Equals("op_Implicit") && t.ReturnType == typeof(JEngine.AntiCheat.JLong) && t.CheckMethodParams(args)).Single();
            app.RegisterCLRMethodRedirection(method, op_Implicit_1);

            app.RegisterCLRCreateDefaultInstance(type, () => new JEngine.AntiCheat.JLong());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref JEngine.AntiCheat.JLong instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as JEngine.AntiCheat.JLong[];
        ...
        static StackObject* op_Implicit_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = (JEngine.AntiCheat.JLong)val;
